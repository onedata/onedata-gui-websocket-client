...
/**
 * @typedef {Object} OwsMessage
 * @property {string} [id] ID is typically generated by requester, then the response has
 *   the same ID.
 * @property {OwsMessageType} type
 * @property {OwsMessageSubtype} subtype
 * @property {OwsRequestPayload} payload
 */

/**
 * @typedef {OwsMessage} OwsRequest
 * @property {OwsMessageType.Request} type
 */

/**
 * @typedef {OwsMessage} OwsResponse
 * @property {OwsMessageType.Response} type
 */

/**
 * @typedef {OwsHandshakeRequestPayload|OwsRpcRequestPayload|OwsGraphRequestPayload|OwsBatchRequestPayload} OwsRequestPayload
 */

/**
 * @typedef {Object} OwsResponsePayload
 * @property {boolean} success
 * @property {null|Object} error
 * @property {OwsResponseData} data
 */

/**
 * @typedef {Object|OwsGraphResponseData} OwsResponseData
 */

/**
 * @typedef {Object} OwsGraphResponseData
 * @property {Object} resource
 * @property {'resource'|'value'} format Data included in the request or response and its
 *   format: resource - data carries a resource with included GRI; value - data carries a
 *   value that is not related to any resource.
 */

/**
 * @typedef {Object} OwsBatchRequestPayload
 * @property {Array<OwsRequest>} batch
 */

/**
 * @typedef {Object} OwsHandshakeRequestPayload
 * @property {Array<number>} supportedVersions
 * @property {string|null} sessionId
 * @property {Object} auth
 */

/**
 * @typedef {Object} OwsRpcRequestPayload
 * @property {string} function
 * @property {Object} args
 */

/**
 * @enum {'request'|'response'|'push'}
 */
export const OwsMessageType = Object.freeze({
  Request: 'request',
  Response: 'response',
  Push: 'push',
});
...
/**
 * @enum {'handshake'|'rpc'|'graph'|'batch'|'unsub'|'nosub'|'error'}
 */
export const OwsMessageSubtype = Object.freeze({
  Handshake: 'handshake',
  Rpc: 'rpc',

  /**
   * Message format: see OwsGraphRequestPayload type.
   */
  Graph: 'graph',

  /**
   * Message format: see OwsBatchRequestPayload type.
   */
  Batch: 'batch',
 ...
 * @returns {Object}
 */
export function wrapRequestPayload(subtype, payload, id = generateUuid()) {
  return {
    id,
    type: OwsMessageType.Request,
    subtype,
    payload,
  };
}
